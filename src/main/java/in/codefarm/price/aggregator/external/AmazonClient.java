...
public class AmazonClient implements PriceAggregator{
    ...
    public double getPrice(String productId){
        ...
        System.out.printf("Took - %d ms to fetch the product %s price from amazon \n", num, productId);
    ...
    public double lastFetchedPrice() {
        System.out.println("fetching last fetched price for amazon - " + lastFetchedPrice);
        return lastFetchedPrice;
    }
